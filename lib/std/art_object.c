...
string *colours = ({"bright chrimson", "blood rod", "orange", "bright yellow", "yellow ochre",
                    "lime green", "forest green", "teal", "sky blue", "cerulean", "phtalo blue",
                    "violet", "lavender", "pink", "brown", "gray", "white", "clear", "black"});
int rolled;
...
void generate_item()
{
    ...
    if (!rolled)
    {
        ...
        {
        case 25..249:
            options = ({"[hmat] +ewer+", "[hmat] +statuette+", "small [hmat] +bracelet+",
                        "[col] [smat] +mask+", "[hmat] +chalice+ with [hmat] filigree",
                        "[col] embroidered [smat] +cloth+", "delicate [hmat] +figurine+",
                        "pair of [hmat] +dice+", "small [hmat] +mirror+ with [col] wooden framing",
                        "[hmat] +bowl+", "[hmat] +plate+",
        ...
        case 250..749:
            options = ({"[hmat] +ring set+ with [col] gems", "large [hmat] +statuette+", "large [hmat] +bracelet+",
                        ...
                        "[smat] +robe+ with [hmat] embroidery", "large [smat] +tapestry+",
                        "[hmat] +mug+ with jade inlay", "box of [col] animal +figurines+",
                        "[hmat] bird +cage+ with [smat] padding"});
