...
void setup()
{
    ...
    set_long("The Model 2620 was manufactured to promote the \"Four Centuries of Revolvers\" convention. This Raust model 2620 is built with two-piece, semi-lug barrel construction for enhanced performance and durability.");
