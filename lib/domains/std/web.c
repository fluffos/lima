...
void setup()
{
   ...
   set_light_msgs("As $n $vlight the web, it bursts into flame and burns away, revealing a key!",
                  "As $n $vlight the web with the $o, the web bursts into flame and burns away, revealing a key!");
   add_relation("in");
...
varargs void do_search(object with, string item)
{
   ...
   this_body()->my_action("You poke around the spiderweb with your $o, and while there is definitely something in "
