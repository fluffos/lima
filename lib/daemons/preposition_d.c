...
mapping oneword_preps =
    (["aboard":"on",
             "above":"on", "against":"near", "alongside":"near", "below":"under", "beneath":"under", "beside":"near",
           "besides":"near", "by":"near", "inside":"in", "into":"in", "onto":"on", "outside":"out", "through":"in",
        "underneath":"under", "upon":"on", "within":"in", "without":"out"]);
// 2 word prepositions
mapping twoword_preps = (["alongside of":"near",
                               "back of":"near", "down from":"down",
                             // The following 2 are likely 3 word compound preposition suffixes
                             //  "from under" : "out",
                             //  "from off" : "off",
                             "inside of":"in", "round about":"near", "near to":"near", "next to":"near", "off of":"off",
                               "over to":"over", "outside of":"out", "out of":"out", "out from":"out", "up to":"up"]);
...
{
   return clean_array(values(oneword_preps) + values(twoword_preps) + values(threeword_preps));
}
