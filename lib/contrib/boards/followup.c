...
private
int filter_removed(object brd, int elem)
{
...
private
void receive_body(object brd, int followup_id, string *body)
{
   if (!body)
   {
...
void main(string arg)
{
   ...
   ids = sort_array(filter_array(NEWS_D->get_messages(brd->query_group()), ( : filter_removed, brd:)), 1);
