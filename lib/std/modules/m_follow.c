...
private
nosave function f_follow = ( : follow_hook:);
private
nosave function arrive = ( : arrive_hook:);
private
mixed *follow_search = ({});
private
object follow;
private
nosave object my_location;
private
nosave int following;
...
private
int follow_match(mixed check, object ob)
{
   if (functionp(check))
