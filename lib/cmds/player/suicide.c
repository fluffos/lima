...
private
nomask void confirm_current_password(string s)
{
   write("\n");
...
void main()
{
   ...
   return;
   modal_simple(( : confirm_current_password:), "Enter your current password to confirm suicide: ", 1);
}
