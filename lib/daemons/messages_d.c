...
mapping messages =
    (["combat-unarmed":
           ...
           "combat-bludgeon":
               (["miss":
                       ({"$N $vswipe $p $o at $t but $vmiss by a mile.",
                         "$N just $vmiss $t, dagnabbit."}),
                        "none":"$N $vhit $t with $p $o, but $n1 $v1do not seem hurt by it.",
                      "disarm":"$N $vgrab $p1 arm, and $vslam it down on $p knee, causing $n1 to drop $p1 $o1.",
                   "knockdown":"$N $vstep behind $t, and $vtrip $t, sending $t flying.",
                       "fatal":"$N $vdrive $t back with a ferocious series of punches and kicks, and $vend with a stunning kick to the head.  $N1 $vslump to the ground, motionless.",
                    "knockout":"$N $vfeint past $p1 guard and $vknock $t senseless.",
                    "dispatch":"$N $vhave no sense of honor; $n $vcave in $p1 $o2 with $p $o.",
                      "wakeup":"$N slowly $vregain $p feet.",
                        ...
                        "dam3":"$N $vconnect with a slam to $p1 $o2.",
         ...
         "combat-paws-bites":
             (["miss":
                     ({"$N $vswing a paw at $t, but $vmiss wildly.",
                       "$N $vattack $t with a paw, but just $vmiss."}),
                 ...
                 "knockdown":"$N $vpounce on $t, sending $t to the ground.",
                  "knockout":"$N $vroar up and $vpounce $p1 head and $vknock $t senseless.",
                     "fatal":"$N $vdrive $t back with a series of attacks, and $vend with a bite to the throat.  $N1 $v1slump to the ground, motionless.",
        ...
        "combat-claws-bites":
            (["miss":
                    ({"$N $vswing a claw at $t, but $vmiss wildly.",
                      "$N $vattack $t with a claw, but just $vmiss."}),
                     "none":"$N $vpounce $t, but $n1 $v1shrug it off.",
                   "disarm":"$N $vbite $p1 arm, causing $p1 to drop $p1 $o1.",
                "knockdown":"$N $vpounce on $t, sending $t to the ground.",
                 "knockout":"$N $vroar up and $vpounce $p1 head and $vknock $t senseless.",
              ...
              "combat-sword":
               ...
               "combat-shot":
                   (["miss":
                           ({"$N $vshoot at $t but $vmiss by a mile.",
                         ...
                         "fatal":
                             ({"$N neatly $vinsert a shot from $p $o between $p1 ribs.  $N1 $v1slump to the ground, dead.",
                               "$N neatly $vinsert a shot from $p $o between $p1 eyes.  $N1 $v1slump to the ground, dead."}),
                       "suicide":"$N $vtake $p $o, and $vshoot $n between the eyes.",
                        "disarm":
                            ({"$N $vsend $p1 $o1 flying with a quick ricochet $ns.",
                              "$N $vhit $p1 hand with $p $o, causing $t to drop $p1 $o1."}),
]),
            "combat-firearm": // $o = 11mm HV bullet, $o2 = torso, $o3 = pistol
                (["miss":
                        ({"$N $vfire $p $o3 at $t but $vmiss by a mile.",
                       ...
                       "dam5":"$N $vmaim $t with a well-aimed $o of $p $o3.",
                       "dam6":"$N $vwound $t with a quick hit.",
                      ...
                      "fatal":
                          ({"$N neatly $vinsert a $o from $p $o3 between $p1 ribs.  $N1 $v1slump to the ground, dead.",
                            "$N neatly $vinsert a $o from $p $o3 between $p1 eyes.  $N1 $v1slump to the ground, dead."}),
                    "suicide":"$N $vtake $p $o, and $vshoot $n between the eyes.",
                     "disarm":
                         ({"$N $vsend $p1 $o1 flying with a quick ricochet $ns.",
                           "$N $vhit $p1 hand with $p $o, causing $t to drop $p1 $o1."}),
