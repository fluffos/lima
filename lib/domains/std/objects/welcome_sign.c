...
This area is going to be used (ever so greatly changed) by a mud the LIMA guys are making.  We are providing this area as an example only!  You can use the code to the extent that you want to code something similar by example, but otherwise, get your own ideas =P
