...
nosave mixed long;
private
nosave mixed in_room_desc;
private
nosave string plural_in_room_desc;
...
protected
string *discarded_message;
protected
string *plural_discarded_message;
...
string show_in_room()
{
   ...
   if (our_count > 1)
   {
      ...
      return capitalize(sprintf(choice(plural_discarded_message), sprintf("%d %s", our_count, plural_short())));
   }
