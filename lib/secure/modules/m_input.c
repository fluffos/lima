...
protected
varargs nomask void modal_push(
    function input_func,
    mixed prompt_func,
    function secure,
...
protected
varargs nomask void modal_func(
    function input_func,
    mixed prompt_func,
    int secure)
{
...
protected
varargs nomask void modal_simple(
    function input_func,
    mixed prompt,
    int secure)
{
...
// the value.
protected
varargs nomask void input_one_arg(
    string arg_prompt,
    function fp,
    string arg)
{
...
private
nomask void rcv_first_of_two(string arg2_prompt,
                             function fp,
                             string arg1)
{
    string arg2;
...
protected
varargs nomask void input_two_args(
    string arg1_prompt,
    string arg2_prompt,
    function fp,
    string arg)
{
    ...
    {
        modal_simple((
                         : rcv_first_of_two, arg2_prompt, fp:),
                     arg1_prompt);
    }
}

private
nomask void rcv_last_of_three(string arg3_prompt,
                              function fp,
                              string arg1,
                              string arg2)
{
...
private
nomask void rcv_second_of_three(string arg2_prompt,
                                string arg3_prompt,
                                function fp,
                                string arg)
{
    ...
    {
        modal_simple((
                         : rcv_last_of_three, arg3_prompt, fp, arg:),
                     sprintf(arg2_prompt, arg1));
    }
}
...
// all present, then the prompts are used to ask for the values.
protected
varargs nomask void input_three_args(
    string arg1_prompt,
    string arg2_prompt,
    string arg3_prompt,
    function fp,
    string arg)
{
    ...
    else
    {
        /* 0 Args */
        modal_simple((
                         : rcv_second_of_three, arg2_prompt, arg3_prompt, fp:),
                     arg1_prompt);
    }
}
