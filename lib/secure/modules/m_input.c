...
private
nosave object input_user;

protected
varargs nomask void modal_push(function input_func, mixed prompt_func, function secure, function return_to_func)
{
...
protected
varargs nomask void modal_func(function input_func, mixed prompt_func, int secure)
{
...
// the value.
protected
varargs nomask void input_one_arg(string arg_prompt, function fp, string arg)
{
...
private
nomask void rcv_first_of_two(string arg2_prompt, function fp, string arg1)
{
   string arg2;
...
protected
varargs nomask void input_two_args(string arg1_prompt, string arg2_prompt, function fp, string arg)
{
   if (arg)
   {
      string arg2;
...
private
nomask void rcv_last_of_three(string arg3_prompt, function fp, string arg1, string arg2)
{
   string arg3;
...
private
nomask void rcv_second_of_three(string arg2_prompt, string arg3_prompt, function fp, string arg)
{
...
// all present, then the prompts are used to ask for the values.
protected
varargs nomask void input_three_args(string arg1_prompt, string arg2_prompt, string arg3_prompt, function fp,
                                     string arg)
{
   string arg1, arg2, arg3;
