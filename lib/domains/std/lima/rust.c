...
void setup()
{
   ...
   set_long("You can't really tell much about him, except that he is male (or at least CLAIMS to be male), and likes "
            "to be called Rust.  Funny how MUDs work like that, eh?\n");

   set_options((["hello":"What's up?",

                  "idea":"What is your idea?", "mudlib":"Want to write a mudlib for me?",

                  "work":"Why will it be so much work?",

               "zork_no":"What's Zork?", "zork_yes":"Of course!  I love that game!",
   ...
   set_responses(
       (["hello":"I've got this great idea for a new MUD!@@idea,mudlib",
             ...
             "mudlib":({"!cha", "You didn't think it would be that easy, did you?", "!wink"}),
               ...
               "work":"I want to create all the Zork rooms, but that will take forever!  Ever played "
                      "Zork?@@zork_yes,zork_no",
           ...
           "zork_yes":({"!smile", "Me too!@@help@@zork_no"}),
               ...
               "help":({"!kewl", "Here is a directory to work in.@@forever",
                        (
                            : handle_help:)}),
