...
void sw_body_handle_new_logon(string);
...
private
nomask int check_special_commands(string arg)
{
   string *b;
...
private
nomask void modify_guest_userid()
{
 ...
 */
private
nomask varargs void login_handle_logon(int state, mixed extra, string arg)
{
   switch (state)
   {
      string *foo;
