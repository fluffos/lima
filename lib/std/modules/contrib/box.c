...
varargs string quote_box(string quote, int width, string author, string frame, string sframe, string corner)
{
   string *lines;
   string *author_lines;
   string s;
...
varargs string box(string text, int width, string frame, string sframe, string corner)
{
   string *lines;
   string s;
   if (!frame)
