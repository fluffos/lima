...
nomask class command_info *module_commands()
{
    return ({
        ...
        new (class command_info,
             ...
             : "[name] [position]",
               args
             : ({"Set position for who? ", "Set %s's postion to what? "}),
               action
             : (
        ...
        new (class command_info,
             ...
             : "[name]",
               args
             : ({"Reset password of which offline user? "}),
               action
             : (
        ...
        new (class command_info,
             ...
             : "[days]",
               args
             : ({"How many days since their last login? "}),
               action
             : (
