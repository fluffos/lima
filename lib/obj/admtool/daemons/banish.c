...
private
nomask void receive_banish_name(string name, string reason)
{
   if (reason == "")
   {
...
private
nomask void receive_banish_site(string name, string reason)
{
   if (reason == "")
   {
      write("Aborted.  The reason is required.\n");
...
private
nomask void show_banishes(string header, class banish_data *list)
{
...
nomask class command_info *module_commands()
{
   return ({
       ...
       new (class command_info, key
            : "B", args
            : ({"Banish who? ", "Banish them why? "}), proto
            : "[name] [reason]", action
            : (
                  : call_other, BANISH_D, "banish_name"
                  :),
              desc
            : "banish a name"),
       new (class command_info, key
            : "b", args
            : ({"Banish which site? ", "Banish them why? "}), proto
            : "[name] [reason]", action
            : (
                  : call_other, BANISH_D, "banish_site"
                  :),
              desc
            : "banish a site"),
       new (class command_info, key
            : "U", proto
            : "[name]", args
            : ({"Unbanish which name? "}), action
            : (
                  : call_other, BANISH_D, "unbanish_name"
                  :),
              desc
            : "unbanish a name"),
       new (class command_info, key
            : "u", proto
            : "[name]", args
            : ({"Unbanish which site? "}), action
            : (
                  : call_other, BANISH_D, "unbanish_site"
                  :),
              desc
            : "unbanish a site"),
       new (class command_info, key
            ...
            : ({"Who? "}), action
            : (
                  : call_other, BANISH_D, "add_registered"
                  :),
              desc
       ...
       new (class command_info, key
            ...
            : ({
              ...
              action
            : (
                  : call_other, BANISH_D, "remove_registered"
                  :),
              desc
       ...
       new (class command_info, key
            ...
            : (
              ...
              desc
            : "show the registered users of a site"),
   });
}
