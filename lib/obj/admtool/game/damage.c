...
private
nomask void add_damage_type(string name)
{
...
private
nomask void remove_damage_type(string name)
{
...
nomask class command_info *module_commands()
{
   return ({
       new (class command_info, key
            : "l", desc
            : "list damage types", action
            : (
                : list_damage_types:)),
       new (class command_info, key
            : "a", proto
            : "[name]", desc
            : "Add a damage type", who
            : "[Mudlib]", priv
            : "Mudlib", args
            : ({"What name? "}), action
            : (
