...
void setup()
{
   ...
   set_long("The river cuts through the north wall of this cave, and wanders through an opening in the east wall.  A "
            "rotting wooden dock  suggests that at one point this cave was likely a secret port, perhaps for pirates.");
   set_light(0);
   set_exits((["north":river, "east":river, "northeast":river, "northwest":"Inside_Cave", ]));
