...
void setup()
{
   ...
   set_long("The waves lap happily onto this sandy beach, which ends here -- the mountains barely meet the water, "
            "leaving not even a grain of sand on which to walk.");
   ...
   set_exits((["south":o, "southeast":o, "southwest":o, ]));
