...
private
void answer_question(string input)
{
   object o;
   ...
   if (o = present(input, environment(this_body())) || o = present(input, this_body()))
...
void complete_dig()
{
   ...
   obs = filter(all_inventory(this_body()) + all_inventory(environment(this_body())), ( : $1->can_dig() :));
   ...
   case 1:
      ...
      return;
   default:
      modal_push(( : answer_question:), "What do you want to dig with? ");
      return;
   }
}
